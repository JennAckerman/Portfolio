...
def get_episode_text(episode_list):
    #Gets text from all episodes in list#
    text_return = []
...
filtered1st = punctuation_stop(all_text)
...
text = " ".join({ele for ele in filtered1st if ele not in unwanted})
